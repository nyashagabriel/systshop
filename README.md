...
4. Create a test user: `python3 manage.py seed_user` (default: `admin`/`admin123`)
5. Start the app with `python3 manage.py runserver`.

## Render deployment

Use these settings on Render:

- Build command: `pip install -r requirements.txt && python manage.py collectstatic --noinput && python manage.py migrate && python manage.py seed_user`
